...
return array(
    ...
    'footer' => '<p class="bold">© 2<sup>nd</sup> International Seminar on Patient Safety and Clinical Excellence</p>
                <a href="'.DIR.'condiciones">Terms & Conditions</a>',
    //Home page
    'jumbotron' => '<span class="bold block">2<sup>nd</sup> International Seminar</span> on Patient Safety and Clinical Excellence',
   ...
   //Programa
       ...
       <div class="row">
        ...
        <div class="row light-gray-background">
            <div class="col-md-9 col-md-offset-3 ">
                <p class="programa-subtitle">Speakers</p>
                <ul class="lista-ponentes">
                    <li>
                        <p class="ponente-name">Dr.  Víctor Madera Núñez</p>
                        <p>President, IDCsalud-Quir&oacute;n.</p>
                    </li>
                    <li>
                        <p class="ponente-name"> Juan Antonio Álvaro de la Parra</p>
                        <p>Director of Public Hospitals of Madrid, IDCsalud-Quir&oacute;n.</p>
                    </li>
                    <li>
        ...
        <div class="row light-gray-background">
            <div class="col-md-9 col-md-offset-3">
                <p class="programa-subtitle">Speaker</p>
                <ul class="lista-ponentes">
                    <li>
                        <p class="ponente-name">Dr. Stephen McAdam</p>
                        <p>Global Healthcare Technical Director in DNV GL. Norway.</p>
                    </li>
                </ul>
                <p>Introduced by <span class="bold">Dra.  Celia García Menéndez</span>. Director of Quality and Patient Safety. IDCsalud-Quir&oacute;n.</p>
            </div>
        </div>
            ...
            <div class="col-md-9 col-md-offset-3 ">
                ...
                <ul class="lista-ponentes">
                    <li>
                        ...
                        <p>Professor of Microbiology in KU Lueven and Head of Laboratory of Clinical Bacteriology and Mycology (University Hospitals Leuven). Belgium.</p>
                    </li>
                </ul>
        ...
        <div class="row light-gray-background">
            <div class="col-md-9 col-md-offset-3 ">
                ...
                <ul class="lista-ponentes">
                    ...
                    <li>
                        <p class="ponente-name">Dr.  Joseba Rebollo Liceaga</p>
                        <p>Chief of the Oncology Dept., Hospital General de Villalba.</p>
                    </li>
                    <li>
                        <p class="ponente-name">Dr.  Eduard Gratacós Solsona</p>
                        <p>Head of Maternal-Fetal Medicine. Hospital Cl&iacute;nic and Hospital Sant Joan de D&eacute;u. Barcelona</p>
                    </li>
                    <li>
                        <p class="ponente-name">Dr.  Pedro Rico Pérez</p>
                        <p>Chief Operating Officer of Private Hospitals, IDCsalud-Quir&oacute;n.</p>
                    </li>
                    <li>
    ...
    //Como llegar
    'direcciones' => '
        <h1 class="invisible">Directions</h1>
        <!-- LOCALIZACION -->
        <div class="accordion-title active">
            <h2><a href="#">Directions to the venue by car</a></h2>
        </div>
        ...
        <div class="accordion-title">
            <h2><a href="#">Directions to the venue by subway</a></h2>
        </div>
    ...
    'prizes' => '
        ...
        <p>With a <span class="bold">total prize of 26.000 euros</span>, this first edition has <span class="bold">4 recognitions</span> ranging from 2.000 and 15.000 euros recognizing the most innovative projects in the area of patient safety. The first and second prizes of 15.000 and 7.000 euros respectively, will be awarded to the two most important projects that have been implemented during the past 2014. There will also be two runners up prizes with a contribution of 2.000 euros each, to be chosen among the most innovative initiatives in 2015 to help finance the projects.</p>
        <p>The application is open to all persons or institutions with projects within the 12 areas of patient safety indicated by the WHO. Applicants may belong to both public and private health centers, or health-related institutions and scientific societies and patient associations, among others, and may submit as many initiatives as deemed relevant for this first edition.</p>
        <p>The <span class = "bold">panel of experts</span> in charge of selecting the winning projects will specially assess the quality of the project\'s methodology, the impact on the organization of the initiative and the value of the results obtained during before and after the intervention of patients, among others. The winning entries will be announced during the <span class = "bold">2<sup>o</sup> International Seminar on Patient Safety and Clinical Excellence</span>, which will take place on May 28<sup>th</sup>, 2015 at the Jimenez Diaz Foundation in Madrid.</p>
        <p>With these awards, the IDCsalud-Quirón Group seeks to contribute to the design, implementation and dissemination of new initiatives to enhance patient safety in all health systems. An initiative that is part of its Strategic Plan initiated in 2012, which marks a fundamental line search of healthcare excellence in all its centers.</p>
        <p>You can check the rules by clicking on the following link (in Spanish).</p>
        <p><span class="fa fa-file-pdf-o red"></span> <a href="http://www.idcsalud.es/es/comunicacion/noticias/grupo-idcsalud-quiron-convoca-i-edicion-premio-mejores-inic.ficheros/126081-I%20Edici%C3%B3n%20Premio%20IDCsalud-Quir%C3%B3n%20DEF.pdf">Terms and conditions of the award (3.5 MB)</a></p>
    ',
);
